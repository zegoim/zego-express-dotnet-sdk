...
public abstract class ZegoMediaPlayer {
    ...
    public ConcurrentDictionary<int, OnSeekToTimeCallback> seekToTimeCallbackDic =
        new ConcurrentDictionary<int, OnSeekToTimeCallback>();
    ...
    public abstract void LoadCopyrightedMusicResourceWithPosition(string resourceID,
                                                                  ulong startPosition,
