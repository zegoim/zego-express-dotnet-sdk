...
namespace ZEGO
{
    public class IZegoEventHandler
    {
        ...
        */
         ...
         */
        public delegate void OnCapturedVideoFrameRawData(byte[] data, uint[] dataLength, ZegoVideoFrameParam param, ZegoVideoFlipMode flipMode, ZegoPublishChannel channel);
        /**
         ...
         * @param streamID Stream ID
         */
        public delegate void OnRemoteVideoFrameRawData(string streamID, byte[] data, uint[] dataLength, ZegoVideoFrameParam param);
        /**
        ...
        */
         ...
         */
        public delegate void OnCapturedAudioData(byte[] data, uint dataLength, ZegoAudioFrameParam param);
        /**
         ...
         * @param param param of audio frame
         */
        public delegate void OnRemoteAudioData(byte[] data, uint dataLength, ZegoAudioFrameParam param);
        /**
         ...
         * @param param param of audio frame
         */
        public delegate void OnMixedAudioData(byte[] data, uint dataLength, ZegoAudioFrameParam param);
    }
}
