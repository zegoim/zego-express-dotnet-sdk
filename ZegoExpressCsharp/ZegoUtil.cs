...
namespace ZEGO
{
    ...
    class ZegoCallBackChangeUtil
    {
        ...
        private static ZegoStreamRelayCDNInfo ChangeZegoStreamRelayCDNInfoStructToClass(zego_stream_relay_cdn_info zego_stream_relay_cdn_info)
        {
            ...
            zegoStreamRelayCDNInfo.updateReason = (ZegoStreamRelayCDNUpdateReason)zego_stream_relay_cdn_info.update_reason;
    ...
    class ZegoImplCallChangeUtil
    {
        ...
        public static zego_engine_config ChangeZegoEngineConfigClassToStruct(ZegoEngineConfig config)
        {
            ...
            if (config.advancedConfig != null)
            {
                ...
                ZegoUtil.ZegoCopy(advancedConfig, ref engineConfig.advanced_config, ZEGO_EXPRESS_MAX_SET_CONFIG_VALUE_LEN);
            }
            else
            {
        ...
        public static zego_mixer_image_info ChangeZegoMixerImageInfoClassToStruct(ZegoMixerImageInfo zegoMixerImageInfo)
        {
            ...
            ZegoUtil.ZegoCopy(zegoMixerImageInfo.url, ref image_info.url, ZegoConstans.ZEGO_EXPRESS_MAX_URL_LEN);
        ...
        public static zego_mixer_input ChangeZegoMixerInputClassToStruct(ZegoMixerInput zegoMixerInput)
        {
            ...
            {
                zego_Mixer_Input.content_type = (zego_mixer_input_content_type)zegoMixerInput.contentType;
                ...
                zego_Mixer_Input.image_info = ChangeZegoMixerImageInfoClassToStruct(zegoMixerInput.imageInfo);
        ...
        public static zego_mixer_output ChangeZegoMixerOutputClassToStruct(ZegoMixerOutput zegoMixerOutput)
        {
            ...
            video_config.encode_profile = (zego_encode_profile)zegoMixerOutput.videoConfig.encodeProfile;
        ...
        public static zego_publisher_config ChangeZegoPublisherConfigToStruct(ZegoPublisherConfig config)
        {
            ...
            if (config != null)
            {
                ...
                result.stream_censorship_mode = (zego_stream_censorship_mode)config.streamCensorshipMode;
            }
        ...
        public static zego_custom_video_render_config ChangeZegoCustomVideoRenderConfigClassToStruct(ZegoCustomVideoRenderConfig config)
        {
            ...
            if (config != null)
            {
                ...
                customVideoRenderConfig.frame_format_series = (zego_video_frame_format_series)config.frameFormatSeries;
