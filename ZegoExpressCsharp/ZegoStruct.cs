...
namespace ZEGO
{
    ...
    public enum zego_room_state_changed_reason {
    ...
    /// Publish channel.
    public enum zego_publish_channel {
    ...
    public enum zego_stream_censorship_mode {
        /// no censorship.
    ...
    public enum zego_video_mirror_mode {
    ...
    public enum zego_publisher_state {
    ...
    public enum zego_voice_changer_preset {
        /// No Voice changer
    ...
    public enum zego_reverb_preset {
        /// No Reverberation
    ...
    public enum zego_electronic_effects_mode {
        /// Major
    ...
    public enum zego_stream_quality_level {
        /// Excellent
    ...
    /// Audio channel type.
    public enum zego_audio_channel {
        /// Unknown
    ...
    public enum zego_audio_capture_stereo_mode {
    ...
    /// Audio mix mode.
    public enum zego_audio_mix_mode {
    ...
    /// Audio codec ID.
    public enum zego_audio_codec_id {
    ...
    public enum zego_video_codec_backend {
    ...
    /// Video stream type
    public enum zego_video_stream_type {
    ...
    public enum zego_encode_profile {
    ...
    public enum zego_video_rate_control_mode {
        /// Constant rate.
    ...
    public enum zego_stream_alignment_mode {
    ...
    public enum zego_traffic_control_property {
    ...
    public enum zego_traffic_control_min_video_bitrate_mode {
    ...
    public enum zego_traffic_control_focus_on_mode {
    ...
    public enum zego_player_media_event {
    ...
    /// Resource Type.
    public enum zego_resource_type {
        /// CDN
    ...
    public enum zego_stream_resource_mode {
    ...
    /// State of CDN relay.
    public enum zego_stream_relay_cdn_state {
    ...
    public enum zego_stream_relay_cdn_update_reason {
        /// No error
    ...
    public enum zego_beautify_feature {
        /// No beautifying
    ...
    public enum zego_device_exception_type {
    ...
    public enum zego_remote_device_state {
        /// Device on
    ...
    /// Audio device type.
    public enum zego_audio_device_type {
        /// Audio input type
    ...
    /// Audio device mode.
    public enum zego_audio_device_mode {
    ...
    public enum zego_mixer_input_content_type {
    ...
    public enum zego_capture_pipeline_scale_mode {
    ...
    /// Video frame format.
    public enum zego_video_frame_format {
    ...
    public enum zego_video_encoded_frame_format {
        /// AVC AVCC format
    ...
    public enum zego_video_buffer_type {
    ...
    public enum zego_video_frame_format_series {
        /// RGB series
    ...
    public enum zego_video_flip_mode {
        /// No flip
    ...
    public enum zego_custom_audio_process_type {
    ...
    /// Player state.
    public enum zego_media_player_state {
        /// Not playing
    ...
    /// Audio channel.
    public enum zego_media_player_audio_channel {
        /// Audio channel left
    ...
    public enum zego_audio_effect_play_state {
        /// Not playing
    ...
    /// audio sample rate.
    public enum zego_audio_sample_rate {
        /// Unknown
    ...
    /// Record type.
    public enum zego_data_record_type {
    ...
    /// Record state.
    public enum zego_data_record_state {
    ...
    public enum zego_audio_data_callback_bit_mask {
    ...
    public enum zego_network_speed_test_type {
        /// uplink
    ...
    public enum zego_ios_orientation {
        /// Unknown value
    ...
    public enum zego_audio_effect_player_instance_index {
        /// Unknown value
    ...
    /// Platform language.
    public enum zego_platform_language {
        /// C language.
    ...
    public enum zego_mix_render_mode {
    ...
    /// Camera focus mode.
    public enum zego_camera_focus_mode {
        /// Auto focus.
    ...
    public enum zego_camera_exposure_mode {
        /// Auto exposure.
    ...
    public enum zego_audio_vad_type {
        /// noise
    ...
    public enum zego_audio_vad_stable_state_monitor_type {
        /// captured
    ...
    public enum zego_orientation_mode {
    ...
    public enum zego_broadcast_mode {
    ...
    public struct zego_custom_video_render_config {
        ...
        public zego_video_frame_format_series frame_format_series;
        ...
        public bool enable_engine_render;
    };

    /// Custom audio configuration.
    public struct zego_custom_audio_config {
        /// Audio capture source type
        public zego_audio_source_type source_type;
    };
    ...
    public struct zego_engine_config {
        ...
        public System.IntPtr log_config;
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ZegoConstans.ZEGO_EXPRESS_MAX_SET_CONFIG_VALUE_LEN)]
    ...
    public struct zego_room_config {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ZegoConstans.ZEGO_EXPRESS_MAX_ROOM_TOKEN_VALUE_LEN)]
        public byte[] token;
    };
    ...
    public struct zego_traffic_control_info {
    ...
    public struct zego_stream {
        ...
        /// Stream extra info
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ZegoConstans.ZEGO_EXPRESS_MAX_EXTRA_INFO_LEN)]
    ...
    public struct zego_canvas {
        ...
        public zego_view_mode view_mode;
    ...
    public struct zego_publisher_config {
        ...
        public zego_stream_censorship_mode stream_censorship_mode;
    };

    /// Advanced scene publisher configuration.
    public struct zego_scene_publisher_config {
    ...
    public struct zego_stream_relay_cdn_info {
        ...
        public zego_stream_relay_cdn_state state;

        /// Reason for relay state changed
        public zego_stream_relay_cdn_update_reason update_reason;
    ...
    public struct zego_player_config {
        ...
        public zego_resource_type source_resource_type;
    ...
    public struct zego_cross_app_info {
        /// AppID for playing streams across apps.
        public uint app_id;

        /// The token that needs to be set.
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = ZegoConstans.ZEGO_EXPRESS_MAX_TOKEN_LEN)]
        public byte[] token;
    };
    ...
    public struct zego_mixer_audio_config {
        ...
        public zego_audio_channel channel;

        /// codec ID, default is ZegoAudioCodecIDDefault
        public zego_audio_codec_id codec_id;
        ...
        public zego_audio_mix_mode mix_mode;
    };
    ...
    public struct zego_mixer_video_config {
        ...
        public zego_video_rate_control_mode rate_control_mode;
    };
    ...
    public struct zego_mixer_output_video_config {
        ...
        public zego_encode_profile encode_profile;
    ...
    public struct zego_mixer_image_info {
    ...
    public struct zego_mixer_input {
        ...
        public zego_mix_render_mode render_mode;
    ...
    public struct zego_mixer_output {
        ...
        public System.IntPtr video_config;
    };
    ...
    public struct zego_mixer_task {
        ...
        public System.IntPtr input_list;

        public uint input_list_count;

        public System.IntPtr output_list;
        ...
        public zego_stream_alignment_mode stream_alignment_mode;
        ...
        public int min_play_stream_buffer_length;
    };
    ...
    public struct zego_camera_capture_params {
    ...
    public struct zego_video_encoded_frame_param {
        /// Video encoded frame format
        public zego_video_encoded_frame_format format;

        /// Whether it is a keyframe
        [MarshalAs(UnmanagedType.I1)]
        public bool is_key_frame;
    ...
    public struct zego_audio_frame_param {
        /// Sampling Rate
        public zego_audio_sample_rate sample_rate;
    ...
    /// audio mixing data.
    public struct zego_audio_mixing_data {
        /// Audio PCM data that needs to be mixed into the stream
        public System.IntPtr audio_data;
        ...
        public zego_audio_frame_param param;
    ...
    public struct zego_custom_audio_process_config {
    ...
    public struct zego_data_record_config {
        ...
        public zego_data_record_type record_type;
    };
    ...
    public struct zego_network_probe_tcp_result {
        ...
        public uint connect_cost_time;
    };

    /// udp probe result
    public struct zego_network_probe_udp_result {
    ...
    public struct zego_network_probe_traceroute_result {
        /// traceroute error code, 0 means normal
        public int error_code;

        /// Time consumed by trace route, the unit is millisecond
        public uint traceroute_cost_time;
    };

    /// Network probe result
    public struct zego_network_probe_result {
        /// http probe result
        public System.IntPtr http_probe_result;

        /// tcp probe result
        public System.IntPtr tcp_probe_result;

        /// udp probe result
        public System.IntPtr udp_probe_result;

        /// traceroute result
        public System.IntPtr traceroute_result;
    };

    /// Network speed test config
    public struct zego_network_speed_test_config {
        /// Test uplink or not
        [MarshalAs(UnmanagedType.I1)]
        public bool test_uplink;
        ...
        public int expected_uplink_bitrate;

        /// Test downlink or not
        [MarshalAs(UnmanagedType.I1)]
        public bool test_downlink;
        ...
        public int expected_downlink_bitrate;
    };

    /// test connectivity result
    public struct zego_test_network_connectivity_result {
        /// connect cost
        public uint connect_cost;
    };

    /// network speed test quality
    public struct zego_network_speed_test_quality {
        ...
        public zego_stream_quality_level quality;
    };
    ...
    /// Orientation.
    public struct zego_position_orientation {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.R4)]
        public float[] axis_up;
    };

    /// Request configuration of song or accompaniment.
    public struct zego_position {
        ...
        /// Motion orientation.
        public zego_position_orientation motion_orientation;

        /// Camera orientation, for 3D range spatializer.
        public zego_position_orientation camera_orientation;
    };

    /// Scene param.
    public struct zego_scene_param {
