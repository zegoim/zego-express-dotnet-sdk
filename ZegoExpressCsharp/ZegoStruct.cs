...
public struct zego_engine_config {
    ...
    [MarshalAs(UnmanagedType.ByValArray,
               SizeConst = ZegoConstans.ZEGO_EXPRESS_MAX_SET_CONFIG_VALUE_LEN)]
...
public struct zego_room_extra_info {
    ...
    [MarshalAs(UnmanagedType.ByValArray,
               SizeConst = ZegoConstans.ZEGO_EXPRESS_MAX_ROOM_EXTRA_INFO_KEY_LEN)]
    public byte[] key;

    /// The value of the room extra information.
    [MarshalAs(UnmanagedType.ByValArray,
               SizeConst = ZegoConstans.ZEGO_EXPRESS_MAX_ROOM_EXTRA_INFO_VALUE_LEN)]
    public byte[] value;
