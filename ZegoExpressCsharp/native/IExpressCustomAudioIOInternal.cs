...
namespace ZEGO
{
    ...
    {
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_enable_audio_data_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///user_context: void*
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_captured_audio_data_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///user_context: void*
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_mixed_audio_data_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_enable_custom_audio_io", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_send_custom_audio_capture_aac_data", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_send_custom_audio_capture_pcm_data", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_fetch_custom_audio_render_pcm_data", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
		...
		[DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_player_audio_data_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
