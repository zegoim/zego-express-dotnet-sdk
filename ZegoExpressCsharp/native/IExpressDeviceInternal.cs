...
namespace ZEGO
{
    public class IExpressDeviceInternal
    {
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_start_sound_level_monitor_with_config", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
