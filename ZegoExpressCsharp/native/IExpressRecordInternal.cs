...
namespace ZEGO
{
    public class IExpressRecordInternal
    {
        ...
        [DllImport(LIB_NAME, EntryPoint = "zego_express_start_recording_captured_data", CallingConvention = ZEGO_CALINGCONVENTION)]
        ...
        [DllImport(LIB_NAME, EntryPoint = "zego_express_stop_recording_captured_data", CallingConvention = ZEGO_CALINGCONVENTION)]
        public static extern int zego_express_stop_recording_captured_data(ZegoPublishChannel channel);

        [DllImport(LIB_NAME, EntryPoint = "zego_register_captured_data_record_state_update_callback", CallingConvention = ZEGO_CALINGCONVENTION)]
