...
public class IExpressCopyrightedMusicInternal {
    ...
    zego_express_copyrighted_music_init(zego_copyrighted_music_config config);
    ...
    public static extern int zego_express_copyrighted_music_request_accompaniment(
        zego_copyrighted_music_request_config config);
    ...
    [DllImport(ZegoConstans.LIB_NAME,
               ...
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern int zego_express_copyrighted_music_get_music_by_token([In()][MarshalAs(
    ...
    [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_copyrighted_music_download",
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern int zego_express_copyrighted_music_download([In()][MarshalAs(
        UnmanagedType.CustomMarshaler,
    ...
    public static extern bool zego_express_copyrighted_music_query_cache(
        [In()][MarshalAs(UnmanagedType.CustomMarshaler,
                         MarshalTypeRef = typeof(ZegoUtil.UTF8StringMarshaler))] string song_id,
    ...
    [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_copyrighted_music_get_duration",
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern ulong zego_express_copyrighted_music_get_duration([In()][MarshalAs(
        UnmanagedType.CustomMarshaler,
        MarshalTypeRef = typeof(ZegoUtil.UTF8StringMarshaler))] string resource_id);
    ...
    [DllImport(ZegoConstans.LIB_NAME,
               ...
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern int zego_express_copyrighted_music_get_previous_score([In()][MarshalAs(
        UnmanagedType.CustomMarshaler,
        MarshalTypeRef = typeof(ZegoUtil.UTF8StringMarshaler))] string resource_id);
    ...
    [DllImport(ZegoConstans.LIB_NAME,
               ...
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern int zego_express_copyrighted_music_get_average_score([In()][MarshalAs(
        UnmanagedType.CustomMarshaler,
        MarshalTypeRef = typeof(ZegoUtil.UTF8StringMarshaler))] string resource_id);

    [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_copyrighted_music_get_total_score",
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern int zego_express_copyrighted_music_get_total_score([In()][MarshalAs(
        UnmanagedType.CustomMarshaler,
        MarshalTypeRef = typeof(ZegoUtil.UTF8StringMarshaler))] string resource_id);
    ...
    [DllImport(ZegoConstans.LIB_NAME,
               ...
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern int zego_express_copyrighted_music_get_standard_pitch([In()][MarshalAs(
        UnmanagedType.CustomMarshaler,
        MarshalTypeRef = typeof(ZegoUtil.UTF8StringMarshaler))] string resource_id);
    ...
    [DllImport(ZegoConstans.LIB_NAME,
               ...
               CallingConvention = ZegoConstans.ZEGO_CALLINGCONVENTION)]
    public static extern int zego_express_copyrighted_music_get_current_pitch([In()][MarshalAs(
        UnmanagedType.CustomMarshaler,
        MarshalTypeRef = typeof(ZegoUtil.UTF8StringMarshaler))] string resource_id);
