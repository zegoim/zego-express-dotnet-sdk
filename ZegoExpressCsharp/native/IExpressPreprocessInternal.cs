...
namespace ZEGO
{
    public class IExpressPreprocessInternal
    {
        ...
        /// Return Type: int
        ///enable: boolean
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_enable_agc", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        /// Return Type: int
        ///enable: boolean
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_enable_ans", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        /// Return Type: int
        ///mode: ZegoAnsMode
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_set_ans_mode", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
