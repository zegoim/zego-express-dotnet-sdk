...
namespace ZEGO
{
    public class IExpressCustomVideoInternal
    {
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_enable_custom_video_processing", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_send_custom_video_processed_raw_data", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_send_custom_video_processed_cv_pixel_buffer", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_send_custom_video_processed_texture_data", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_custom_video_process_captured_unprocessed_raw_data_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_custom_video_process_captured_unprocessed_cvpixelbuffer_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_custom_video_process_captured_unprocessed_texture_data_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
