...
namespace ZEGO
{
    public class IExpressPublisherInternal
    {
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_start_publishing_stream_with_config", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_stop_publishing_stream", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        public static extern int zego_express_stop_publishing_stream(ZegoPublishChannel channel);



        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_publisher_state_update_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_start_preview", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        public static extern int zego_express_start_preview(System.IntPtr canvas, ZegoPublishChannel channel);
        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_stop_preview", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        public static extern int zego_express_stop_preview(ZegoPublishChannel channel);


        [DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_set_app_orientation", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_set_video_config", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///channel: zego_publish_channel
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_set_video_mirror_mode", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///mute: boolean
        ///channel: zego_publish_channel
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_mute_publish_stream_audio", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///mute: boolean
        ///channel: zego_publish_channel
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_mute_publish_stream_video", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///enable: boolean
        ///property: int
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_enable_traffic_control", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_set_min_video_bitrate_for_traffic_control", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        /// Return Type: int
        ///volume: int
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_set_capture_volume", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        public static extern int zego_express_set_capture_volume(int volume);


        /// Return Type: int
        ///enable: boolean
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_enable_hardware_encoder", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///user_context: void*
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_publisher_quality_update_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///user_context: void*
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_publisher_captured_audio_first_frame_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///user_context: void*
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_publisher_captured_video_first_frame_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///user_context: void*
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_publisher_video_size_changed_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///user_context: void*
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_register_publisher_relay_cdn_state_update_callback", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        ///channel: zego_publish_channel
        [System.Runtime.InteropServices.DllImportAttribute(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_send_sei", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        ...
        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_get_audio_config", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
        public static extern zego_audio_config zego_express_get_audio_config();

        [DllImport(ZegoConstans.LIB_NAME, EntryPoint = "zego_express_get_video_config", CallingConvention = ZegoConstans.ZEGO_CALINGCONVENTION)]
