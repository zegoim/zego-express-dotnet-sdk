...
public class ZegoAudioEffectPlayerImpl : ZegoAudioEffectPlayer {
    public ConcurrentDictionary<int, OnAudioEffectPlayerSeekToCallback>
        onAudioEffectPlayerSeekToCallbackDics =
            new ConcurrentDictionary<int, OnAudioEffectPlayerSeekToCallback>();
    public ConcurrentDictionary<int, OnAudioEffectPlayerLoadResourceCallback>
        onAudioEffectPlayerLoadResourceCallbackDics =
            new ConcurrentDictionary<int, OnAudioEffectPlayerLoadResourceCallback>();
    ...
    private int CheckZegoAudioEffectPlayer(ZegoAudioEffectPlayer audioEffectPlayer) {
        int index =
            GetIndexFromObject<ZegoAudioEffectPlayer>(audioEffectPlayerAndIndex, audioEffectPlayer);
        if (index < 0) {
            throw new Exception(
                "may be you had already destroyed the audioEffectPlayer or create the ZegoAudioEffectPlayer but no use ZegoExpressEngine.CreateAudioEffectPlayer");
        }
        return index;
    }
    ...
    public override void Pause(uint audioEffectID) {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result = IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_pause(
                audioEffectID, (ZegoAudioEffectPlayerInstanceIndex)index);
            string log = string.Format("AudioEffectPlayer Pause audioEffectID:{0}  result:{1}",
                                       audioEffectID, result);
            ZegoUtil.ZegoPrivateLog(result, log, true,
                                    ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
        }
    }
    ...
    public override void PauseAll() {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result =
                IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_pause_all(
                    (ZegoAudioEffectPlayerInstanceIndex)index);
    ...
    public override void Resume(uint audioEffectID) {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result = IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_resume(
                audioEffectID, (ZegoAudioEffectPlayerInstanceIndex)index);
            string log = string.Format("AudioEffectPlayer Resume audioEffectID:{0}  result:{1}",
                                       audioEffectID, result);
            ZegoUtil.ZegoPrivateLog(result, log, true,
                                    ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
        }
    ...
    public override void ResumeAll() {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result =
                IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_resume_all(
                    (ZegoAudioEffectPlayerInstanceIndex)index);
    ...
    public override void SetVolume(uint audioEffectID, int volume) {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result =
                IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_set_volume(
                    audioEffectID, volume, (ZegoAudioEffectPlayerInstanceIndex)index);
            string log = string.Format(
                "AudioEffectPlayer SetVolume audioEffectID:{0} volume:{1}  result:{2}",
                audioEffectID, volume, result);
            ZegoUtil.ZegoPrivateLog(result, log, true,
                                    ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
        }
    }
    ...
    public override void SetVolumeAll(int volume) {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result =
                IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_set_volume_all(
                    volume, (ZegoAudioEffectPlayerInstanceIndex)index);
            string log = string.Format("AudioEffectPlayer SetVolumeAll volume:{0}  result:{1}",
                                       volume, result);
            ZegoUtil.ZegoPrivateLog(result, log, true,
                                    ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
        }
    ...
    public override void Start(uint audioEffectID, string path, ZegoAudioEffectPlayConfig config) {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            zego_audio_effect_play_config audio_Effect_Play_Config =
                ChangeZegoAudioEffectPlayConfigClassToStruct(config);
            IntPtr ptr = ZegoUtil.GetStructPointer(audio_Effect_Play_Config);
            int result = IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_start(
                audioEffectID, path, ptr, (ZegoAudioEffectPlayerInstanceIndex)index);
            ZegoUtil.ReleaseStructPointer(ptr);
            string log =
                string.Format("AudioEffectPlayer Start audioEffectID:{0} path:{1} result:{2}",
                              audioEffectID, path, result);
            ZegoUtil.ZegoPrivateLog(result, log, true,
                                    ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
        }
    }
    ...
    public override void Stop(uint audioEffectID) {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result = IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_stop(
                audioEffectID, (ZegoAudioEffectPlayerInstanceIndex)index);
            string log = string.Format("AudioEffectPlayer Stop audioEffectID:{0}  result:{1}",
                                       audioEffectID, result);
            ZegoUtil.ZegoPrivateLog(result, log, true,
                                    ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
        }
    ...
    public override void StopAll() {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result =
                IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_stop_all(
                    (ZegoAudioEffectPlayerInstanceIndex)index);
    ...
    public override void UnloadResource(uint audioEffectID) {
        if (enginePtr != null) {
            int index = CheckZegoAudioEffectPlayer(this);
            int result =
                IExpressAudioEffectPlayerInternal.zego_express_audio_effect_player_unload_resource(
                    audioEffectID, (ZegoAudioEffectPlayerInstanceIndex)index);
    ...
    public static void
    zego_on_audio_effect_player_seek_to(int seq, int error_code,
        ...
        lock(zegoAudioEffectPlayerLock) {
            ...
            if (zegoAudioEffectPlayerImpl.onAudioEffectPlayerSeekToCallbackDics != null) {
                ...
                ZegoUtil.ZegoPrivateLog(error_code, log, true,
                                        ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
                OnAudioEffectPlayerSeekToCallback callback =
                    GetCallbackFromSeq<OnAudioEffectPlayerSeekToCallback>(
                        zegoAudioEffectPlayerImpl.onAudioEffectPlayerSeekToCallbackDics, seq);
                if (callback == null) {
                    return;
                }
                ...
                context?.Post(new SendOrPostCallback((o) => {
                                  ...
                                  zegoAudioEffectPlayerImpl?.onAudioEffectPlayerSeekToCallbackDics
                                      ?.TryRemove(seq, out _);
                              }),
                              null);
    ...
    public static void
    zego_on_audio_effect_player_load_resource(int seq, int error_code,
                                              ZegoAudioEffectPlayerInstanceIndex instance_index,
                                              System.IntPtr user_context) {
        lock(zegoAudioEffectPlayerLock) {
            ZegoAudioEffectPlayerImpl zegoAudioEffectPlayerImpl =
            ...
            if (zegoAudioEffectPlayerImpl.onAudioEffectPlayerLoadResourceCallbackDics != null) {
                ...
                ZegoUtil.ZegoPrivateLog(error_code, log, true,
                                        ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
                OnAudioEffectPlayerLoadResourceCallback callback =
                    GetCallbackFromSeq<OnAudioEffectPlayerLoadResourceCallback>(
                        zegoAudioEffectPlayerImpl.onAudioEffectPlayerLoadResourceCallbackDics, seq);
                if (callback == null) {
                    return;
                }
    ...
    public static void zego_on_audio_effect_play_state_update(
        uint audio_effect_id, ZegoAudioEffectPlayState state, int error_code,
        ZegoAudioEffectPlayerInstanceIndex instance_index, System.IntPtr user_context) {
        ZegoAudioEffectPlayerImpl zegoAudioEffectPlayerImpl =
            (ZegoAudioEffectPlayerImpl)GetObjectFromIndex(audioEffectPlayerAndIndex,
                                                          (int)instance_index);
        if (zegoAudioEffectPlayerImpl.onAudioEffectPlayStateUpdate != null) {
            ...
            ZegoUtil.ZegoPrivateLog(error_code, log, true,
                                    ZegoConstans.ZEGO_EXPRESS_MODULE_AUDIOEFFECTPLAYER);
            context?.Post(new SendOrPostCallback((o) => {
                              zegoAudioEffectPlayerImpl?.onAudioEffectPlayStateUpdate?.Invoke(
                                  zegoAudioEffectPlayerImpl, audio_effect_id, state, error_code);
                          }),
                          null);
