...
public class ZegoMediaPlayerImpl : ZegoMediaPlayer {
    ...
    public override void LoadCopyrightedMusicResourceWithPosition(string resourceID,
                                                                  ulong startPosition,
                                                                  OnLoadResourceCallback callback) {
        this.onLoadResourceCallback = callback;
        ZegoMediaPlayerInstanceIndex curIndex =
            ZegoExpressEngineImpl.GetIndexFromZegoMediaPlayer(this);
        int result = IExpressMediaPlayerInternal
                         .zego_express_media_player_load_copyrighted_music_resource_with_position(
                             resourceID, (IntPtr)startPosition, curIndex);
        string log = string.Format(
            "loadCopyrightedMusicResourceWithPosition, resourceID:{0}  startPosition:{1} ",
    ...
    public override void Start() { ZegoExpressEngineImpl.Start(this); }
    public override void Pause() { ZegoExpressEngineImpl.Pause(this); }
    public override void Resume() { ZegoExpressEngineImpl.Resume(this); }
    public override void Stop() { ZegoExpressEngineImpl.Stop(this); }
    ...
    public override void EnableAux(bool enable) { ZegoExpressEngineImpl.EnableAux(this, enable); }
    public override void MuteLocal(bool mute) { ZegoExpressEngineImpl.MuteLocal(this, mute); }
    public override void SetPlayerCanvas(ZegoCanvas canvas) {
        ZegoExpressEngineImpl.SetPlayerCanvas(this, canvas);
    }
    public override void SetVolume(int volume) { ZegoExpressEngineImpl.SetVolume(this, volume); }
    ...
    public override int GetIndex() { return ZegoExpressEngineImpl.GetIndex(this); }
