...
public class IZegoCopyrightedMusicHandler {
    /**
         ...
         */
    public delegate void OnDownloadProgressUpdate(ZegoCopyrightedMusic copyrightedMusic,
                                                  string resourceID, float progressRate);
}
/**
...
/**
     ...
     */
public delegate void OnCopyrightedMusicSendExtendedRequest(int errorCode, string command,
                                                           string result);
